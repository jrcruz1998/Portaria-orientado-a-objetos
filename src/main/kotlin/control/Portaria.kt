...
class Portaria {
    ...
    private fun controle(): String {
        ...
        if (!convidadoBusiness.tipoValido(convidado.tipo)) { // verifica se o tipo do convite é válido
            return "Negado. Convite inválido."
        }

        convidado.codigo = Console.readString("Qual o código do convite? ")
        if (!convidadoBusiness.convidadoValido(convidado)) { // verifica se o tipo do convite é válido
            return "Negado. Convite inválido."
        }
